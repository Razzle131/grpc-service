...
var (
	filter_Customizer_RemoveDNS_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Customizer_RemoveDNS_0(ctx context.Context, marshaler runtime.Marshaler, client CustomizerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Customizer_RemoveDNS_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterCustomizerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CustomizerServer) error {
	...
	mux.Handle("DELETE", pattern_Customizer_RemoveDNS_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
